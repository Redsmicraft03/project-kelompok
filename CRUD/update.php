...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $gambar_path = $_POST['existing_gambar']; // Gambar yang sudah ada
    $old_gambar = $_POST['existing_gambar']; // Simpan path gambar lama untuk dihapus jika diganti
    ...
    if (empty($nama_produk) || empty($jenis) || empty($harga)) {
        ...
        if (empty($error_message)) {
            ...
            $query = "UPDATE produk SET nama_produk=?, jenis=?, harga=?, deskripsi=?, gambar=? WHERE id=?";
            $stmt = mysqli_prepare($db, $query);
            mysqli_stmt_bind_param($stmt, "ssissi", $nama_produk, $jenis, $harga, $deskripsi, $gambar_path, $id);
            
            if (mysqli_stmt_execute($stmt)) {
                // Hapus gambar lama jika ada gambar baru yang diupload dan gambar lama berbeda
                if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] == 0 && !empty($old_gambar) && $old_gambar != $gambar_path) {
                ...
                if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] == 0 && $gambar_path != $old_gambar && file_exists("../" . $gambar_path)) {
                    unlink("../" . $gambar_path);
                }
            }
        }
...
<head>
    ...
    <title>Edit Produk - Kio-Food</title>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <p>Perbarui informasi produk cireng</p>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="product-info">
                    <h3><i class="fas fa-info-circle"></i> Informasi Produk Saat Ini</h3>
                    <div class="info-grid">
                        <div class="info-item">
                            <span class="info-label">ID Produk</span>
                            <span class="info-value">#<?php echo $produk['id']; ?></span>
                        </div>
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                ...
                                if (isset($produk['created_at'])) {
                                    echo date('d F Y', strtotime($produk['created_at'])); 
                                } else {
                ...
                <form action="../CRUD/update.php?id=<?php echo $produk['id']; ?>" method="POST" enctype="multipart/form-data" id="productForm">
                    <input type="hidden" name="existing_gambar" value="<?php echo htmlspecialchars($produk['gambar'] ?? ''); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select id="jenis" name="jenis" class="form-control" required>
                            ...
                            <option value="Makanan" <?php echo ($produk['jenis'] == 'Makanan') ? 'selected' : ''; ?>>
                                Makanan
                            </option>
                            <option value="Minuman" <?php echo ($produk['jenis'] == 'Minuman') ? 'selected' : ''; ?>>
                                Minuman
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-image">
                            <h4 style="margin-bottom: 10px; color: var(--gray-600); font-size: 14px;">Gambar Saat Ini:</h4>
                            <?php if (!empty($produk['gambar']) && file_exists("../" . $produk['gambar'])): ?>
                                <img src="../<?php echo htmlspecialchars($produk['gambar']); ?>" alt="Gambar Produk">
                            <?php else: ?>
                                <div class="no-image">
                                    <i class="fas fa-image"></i>
                                    Belum ada gambar
                        ...
                        <div class="image-change-section">
                            <h4><i class="fas fa-upload"></i> Ganti Gambar (Opsional)</h4>
                        ...
                        <div class="form-text">Format yang didukung: JPG, JPEG, PNG, GIF, WebP (Maksimal 5MB). Kosongkan jika tidak ingin mengubah gambar.</div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                submitBtn.innerHTML = '<div class="loading"></div> Mengupdate...';
